...
# The remaining code was for a side project to use NLP methods to conduct route prediction.
# its a little weedy, but the bottom lines are below in text:

# For N==7 and top==1:, accuracy = 0.1928 and precision = 0.52778
# Trues=209, Falses=187, Nones=688
# For N==8 and top==1:, accuracy = 0.12454 and precision = 0.49091
# Trues=135, Falses=140, Nones=809
# For N==9 and top==1:, accuracy = 0.09502 and precision = 0.6358
# Trues=103, Falses=59, Nones=922
# For N==10 and top==1:, accuracy = 0.07011 and precision = 0.64407
# Trues=76, Falses=42, Nones=966
# For N==11 and top==1:, accuracy = 0.05627 and precision = 0.67033
# Trues=61, Falses=30, Nones=993
# For N==12 and top==1:, accuracy = 0.04244 and precision = 0.65714
# Trues=46, Falses=24, Nones=1014
# For N==13 and top==1:, accuracy = 0.03321 and precision = 0.70588
# Trues=36, Falses=15, Nones=1033
# For N==14 and top==1:, accuracy = 0.02122 and precision = 0.67647
# Trues=23, Falses=11, Nones=1050
